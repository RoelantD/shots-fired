...
Most developers treat it like a search engine. They type a question. They get an answer. They complain that the answer is mediocre. Then they try a different model or exit the stage disillusioned.
...
> Context is everything to the model
...
The model doesn't know what your app is. It doesn't know your stack, your threat model, your team size, what your background is, or whether "best" means most secure, fastest to ship, or cheapest to maintain. So it gives you the Wikipedia version of authentication. Technically correct. Completely useless for your usecase.
...
**Cast the character.** Who do you want answering this? A cautious architect? A pragmatic senior engineer? Someone who will tell you when your approach is wrong rather than just completing the task? You've worked with both types. You know which one you need right now, and it is ok if sometimes you only need a rubber duck. 🦆
...
You can bake this into a custom GPT, a system prompt in your IDE extension, store it in memory, or just keep it as a snippet you paste. The point isn't the format. The point is that the model needs to know what scene it's in before you call action.
...
> We asked to be in the loop, so BE in the loop
...
Your LLM is standing by. It has no idea what kind of developer you are, what you're building, what you value, or what a good answer looks like for your specific problem. It is waiting for direction.

So give it some. Be the director it needs. Be in the loop.  
